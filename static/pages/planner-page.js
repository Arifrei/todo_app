...
function renderMultiItemTile(item, variant = 'tile') {
    ...
    tile.innerHTML = `
        <button class="planner-item-header" type="button" onclick="togglePlannerMulti(${item.id})">
            <div>
    ...
    lines.forEach(line => {
        ...
        const lineNoteButtons = lineNotes.map(note => {
            ...
            return `<button class="btn-icon planner-line-note-btn ${isNote ? 'note' : 'list'}" type="button" onclick="openPlannerNotePreview(${note.id})" title="${escapeHtml(title)}" aria-label="Open linked ${isNote ? 'note' : 'list'}: ${escapeHtml(title)}">
        ...
        row.innerHTML = `
            ...
            <div class="planner-line-actions">
                ${lineNoteButtons}
                ${line.line_type === 'url' ? `
                    <button class="btn-icon" type="button" onclick="openPlannerLine(${line.id})" title="Open" aria-label="Open link">
                        <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    </button>
                ` : ''}
                <button class="btn-icon" type="button" onclick="openPlannerDateModal('line', ${line.id})" title="Set date" aria-label="Set line date">
                    <i class="fa-regular fa-calendar"></i>
                </button>
                <button class="btn-icon" type="button" onclick="copyPlannerLine(${line.id})" title="Copy" aria-label="Copy line">
                    <i class="fa-solid fa-copy"></i>
                </button>
                <button class="btn-icon" type="button" onclick="deletePlannerLine(${line.id})" title="Delete" aria-label="Delete line">
                    <i class="fa-solid fa-trash"></i>
                </button>
            </div>
        `;
